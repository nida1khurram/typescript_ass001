...
console.log("Task 9: Store  array in alphabetical order", places_visit.sort());
// // • Sort to change your array so it’s stored in reverse alphabetical order. Print the list to show that its order has changed.
console.log("Task 10: Store  array in reverse alphabetical order", places_visit.sort().reverse());
